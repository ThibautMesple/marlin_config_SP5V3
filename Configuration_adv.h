 ...
 */
#define INPUT_SHAPING_X //ttrees
#define INPUT_SHAPING_Y //ttrees
    ...
    #define SHAPING_FREQ_Y  55.0        // (Hz) The default dominant resonant frequency on the Y axis.
...
#define BABYSTEPPING    //ttrees
  ...
  #define BABYSTEP_DISPLAY_TOTAL      //ttrees    // Display total babysteps since last G28

  #define BABYSTEP_ZPROBE_OFFSET     //ttrees     // Combine M851 Z and Babystepping
 ...
 */
//#define ADVANCED_PAUSE_FEATURE  //ttrees
 ...
 * @section tmc/config
 */
//#if HAS_TRINAMIC_CONFIG || HAS_TMC26X //ttrees
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       1100       //ttrees // (mA) RMS current. Multiply by 1.414 for peak current.
   ...
   */
  #define STEALTHCHOP_XY  //ttrees
  #define STEALTHCHOP_Z   //ttrees
  #define STEALTHCHOP_E   //ttrees
  #if HAS_STEALTHCHOP
...
//#endif // HAS_TRINAMIC_CONFIG || HAS_TMC26X //ttrees

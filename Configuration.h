...
#define STRING_CONFIG_H_AUTHOR "(Twotrees SP5V3, T.Mesple)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MKS_ROBIN_NANO_V3 //ttrees
#endif
 ...
 */
#define BAUDRATE 250000 //ttrees 115200
 ...
 */
#define X_DRIVER_TYPE  TMC2209  //ttrees
#define Y_DRIVER_TYPE  TMC2209  //ttrees
#define Z_DRIVER_TYPE  TMC2209  //ttrees
...
#define E0_DRIVER_TYPE TMC2209  //ttrees
...
#define X_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. //ttrees
...
#define Y_MAX_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. //ttrees
 ...
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 412 }  //ttrees
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 562 }  //ttrees new orbiter extruder
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 5, 25 } //ttrees
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 100, 1000 }   //ttrees
...
#define DEFAULT_ACCELERATION          2000    //ttrees // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  1000    //ttrees // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   2000    //ttrees // X, Y, Z acceleration for travel (non printing) moves
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -10, -50, -2.35 }    //ttrees
...
#define INVERT_X_DIR true     //ttrees
#define INVERT_Y_DIR true     //ttrees
#define INVERT_Z_DIR true     //ttrees
...
#define INVERT_E0_DIR false    //ttrees new orbiter
//#define INVERT_E0_DIR true    //ttrees old extruder
...
#define X_BED_SIZE 297  //ttrees
#define Y_BED_SIZE 297  //ttrees
 ...
 */
//#define FILAMENT_RUNOUT_SENSOR  //ttrees
 ...
 */
#define RESTORE_LEVELING_AFTER_G28  //ttrees
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 3   //ttrees
  ...
  //#define PROBE_Y_FIRST
    ...
    //
    #define ABL_BILINEAR_SUBDIVISION    //ttrees
    #if ENABLED(ABL_BILINEAR_SUBDIVISION)
      // Number of subdivisions between probe points
      #define BILINEAR_SUBDIVISIONS 3     //ttrees
    #endif
 ...
 */
#define EEPROM_SETTINGS     //ttrees // Persistent storage with M500 and M501
...
#define TFT_LVGL_UI //ttrees
  ...
  #define MKS_WIFI_MODULE // MKS WiFi module  //ttrees
#endif
